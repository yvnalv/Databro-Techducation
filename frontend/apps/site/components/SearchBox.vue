...
<template>
  ...
  >
    ...
    <input
      ...
      class="h-9 w-full rounded-control border border-line-strong bg-surface-raised pl-9 pr-3 text-sm text-ink placeholder:text-ink-subtle focus:border-accent-strong focus:outline-none focus:ring-2 focus:ring-accent-strong/25"
    />
